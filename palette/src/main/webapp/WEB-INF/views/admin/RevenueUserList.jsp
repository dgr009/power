		...
		<section class="page_head">
            ...
            <br><br>
                ...
                <div class="col-sm-12 text-center"  id="pagination" >
                	<c:if test="${r.pagination.prev>0 }"><a href="/palette/admin/revenueUserList?pageNo=${i}&startDate=${r.sDate}&endDate=${r.eDate}&userId=${r.ownerId}">이전으로</a></c:if>
			
			<c:forEach var="i" begin="${r.pagination.startPage}" end="${r.pagination.endPage}">
				<a href="/palette/admin/revenueUserList?pageNo=${i}&startDate=${r.sDate}&endDate=${r.eDate}&userId=${r.ownerId}">${i} </a>
			</c:forEach>
			
		<c:if test="${r.pagination.next>0 }"><a href="/palette/admin/revenueUserList?pageNo=${r.pagination.next}&startDate=${r.sDate}&endDate=${r.eDate}&userId=${r.ownerId}">다음으로</a></c:if>
