	...
	<!-- End Header -->
		...
		<section class="page_head">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
							...
							<h3><i class="fa fa-info-circle"></i>&nbsp; 고객서비스센터 글 작성</h3>
								<table class="table table-striped table-hover" style="text-align: center;">
				                    <thead>
				                    <tr>
										<form  action="/palette/main/customerCenter/register" method="post">
										<h3 style="display: inline-block;">제목 : </h3>&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" style="width:730px;"name="faqTitle">
              		   ...
              		   <textarea rows="15" cols="" name="faqContent" ></textarea>
						<br>		
              		   			<div id="id"></div>
