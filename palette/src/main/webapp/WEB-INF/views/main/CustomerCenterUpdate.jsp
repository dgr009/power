	 ...
	 <%@ include file="/WEB-INF/views/header/MainHeader.jsp" %>
		...
		<!--start wrapper-->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
							...
							<form 
							action="/palette/main/customerCenter/update"
							method="post">
							...
							<!-- 게시물 제목 -->
							     <input type="text" name="faqTitle" style="width:730px;" value="${result.result.faqTitle }"></h3>
              		   ...
              		   <textarea rows="15" cols=""  name="faqContent" >${result.result.faqContent }
							</textarea></p>
