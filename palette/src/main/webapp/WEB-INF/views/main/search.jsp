...
<br>
	...
	${search}</span> 에 대한 홈페이지  <span style="font-size: 1.1em">${result.homePageCnt.intValue()}</span>건&nbsp; 상품&nbsp;${result.itemListCnt.intValue()}건의 검색 결과입니다 &nbsp;<i class="fa fa-search-plus " style="color:#727cb6;"></i></p> 
