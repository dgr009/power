...
<!--Start Header-->
	<header id="header">
		...
		<!--start wrapper-->
			...
			<div class="well well-lg" style="padding-right: 50px; padding-left: 50px; margin-left: 50px; margin-right: 50px; padding-top: 10px;"><h3><i class="fa fa-info-circle"></i>&nbsp;     자주묻는 글 게시판</h3>
                    	...
                    	<c:forEach items="${result.result }" var="free">
							<tr>			
								...
								<td style="text-align: left; ">
									<a href="/palette/main/customerCenter/view/${free.faqNo.intValue()}" id="under">
										${free.faqTitle}
									</a>
								</td>
								<td>
                	...
                	<div id="pagination" style="text-align: center;">
			         <ul class='pagination' style='height: 20px;' >
						...
						<c:forEach var="i" begin="${result.pagination.startPage}" end="${result.pagination.endPage}">
							<li><a href="/palette/main/customerCenter/list?pageNo=${i}">${i} </a></li>
						</c:forEach>
						
						<c:if test="${result.pagination.next>0 }">
							<a href="/palette/main/customerCenter/list?pageNo=${result.pagination.next.intValue()}">다음</a>
						</c:if>
					</ul>
                 </div>
                 
              	<div class="col-lg-9 col-md-9 col-sm-9">
              		   		<a href="../customerCenter/list?pageNo=1"><input type="button" data-loading-text="Loading..." class="btn btn-default btn-lg" value="이전으로" style="color:white;"></a>
              		   </div>  
              		   <%if(session.getAttribute("admin")!=null){ %>
              		   <div class="col-lg-3 col-md-3 col-sm-3"  style="text-align: right;">
              		   	<input type="button" data-loading-text="Loading..." class="btn btn-default btn-lg" value="글 작성" onclick="window.location.href='/palette/main/customerCenter/register'"  style="color:white;"/></div>
						<%} %>                
					<br>  <br>
                </div>
                 <br>  <br><br>  <br>
