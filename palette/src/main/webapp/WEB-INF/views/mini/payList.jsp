...
<body>
				...
				<table class="table table-striped table-hover" style="text-align: center;">
                    ...
                    <tbody id="free">
                    	<c:forEach items="${mini2.list }" var="active">
							<tr>			
								<td>
									${active.activeNo.intValue() }
								</td>
								<td>
									${active.activeStart }
								</td>
                	...
                	<div id="pagination" style="text-align: center;">
			         <ul class='pagination' style='height: 20px;' >
			         	<c:if test="${mini2.pagination.prev>0 }">
							<li><a href="/palette/miniHome/payList?pageNo=${mini2.pagination.prev.intValue()}">이전</a></li>
						</c:if>
						
						<c:forEach var="i" begin="${mini2.pagination.startPage}" end="${mini2.pagination.endPage}">
							<li><a href="/palette/miniHome/payList?pageNo=${i}">${i} </a></li>
						</c:forEach>
						
						<c:if test="${mini2.pagination.next>0 }">
							<a href="/palette/miniHome/payList?pageNo=${mini2.pagination.next.intValue()}">다음</a>
						</c:if>
					</ul>
                 </div>
