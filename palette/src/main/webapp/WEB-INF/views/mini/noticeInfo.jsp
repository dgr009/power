...
<body>
	...
	<table border="1">
		<tr><td>번호</td><td>${mini.noticeArticleNo.intValue() }</td></tr>
		<tr><td>제목</td><td>${mini.noticeArticleTitle }</td></tr>
		<tr><td>내용</td><td>${mini.noticeArticleContent }</td></tr>
		<tr><td>시간</td><td>${mini.noticeArticleDate }</td></tr>
		<tr><td>작성자</td><td>${mini.userId }</td></tr>
	</table>
