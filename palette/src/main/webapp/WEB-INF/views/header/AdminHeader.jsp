            ...
            <div class="container">
                <div class="row">
                    <div class="hidden-xs col-lg-7 col-sm-5 top-info">
               			 ...
               			 <span class="hidden-sm" style="color:white"><%=%> 회원님</a></span>
               			  <span class="hidden-sm"style="color:white"><%=%> 등급</a></span>
               			  <span class="hidden-sm"style="color:white">포인트:<%=%>P </a></span>
                       
                         <span class="hidden-sm"><a href="/hooligan/customer/charge" style="color:white">충전하기</a></span>
                            ...
                            <li>
                                <form class="search-bar">
                                    <label for="search" class="search-label">
                                        ...
                                        --><input type="text" id="search" class="search-input"  name="itemName"/>
                                    </label>
                                </form>
                            </li>
                        </ul>
