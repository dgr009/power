...
public class RevenueController {
	...
	public String revenueList(Model model, @RequestParam(required = false) Date startDate,
			@RequestParam(required = false) Date endDate, @RequestParam(defaultValue = "1") int pageNo) {
		if (startDate != null)
	...
	public String revenueUserList(Model model, @RequestParam(defaultValue = " ") String userId,
