...
public class MainController {
	...
	public String updateReple(@ModelAttribute MainFreeReple reple, @RequestParam String mainFreeRepleContent,
			@RequestParam int mainArticleNo, @PathVariable int mainFreeRepleNo2) {
